...
namespace HorrorShorts_Game.Controls.UI.Questions
{
    public class QuestionBox
    {
        ...
        private void GetZone()
        {
            ...
            {
                QuestionBoxLocation.TopLeft             => new(Core.Resolution.Bounds.Left,
                                                             Core.Resolution.Bounds.Top,
                                                             globalWidth, globalHeight),
                QuestionBoxLocation.TopCenter           => new(Core.Resolution.Bounds.Center.X - halfGlobalWidth, 
                                                             Core.Resolution.Bounds.Top, 
                                                             globalWidth, globalHeight),
                QuestionBoxLocation.TopRight            => new(Core.Resolution.Bounds.Right - globalWidth, 
                                                             Core.Resolution.Bounds.Top, 
                                                             globalWidth, globalHeight),
                QuestionBoxLocation.MiddleLeft          => new(Core.Resolution.Bounds.Left, 
                                                             Core.Resolution.Bounds.Center.Y - halfGlobalHeight, 
                                                             globalWidth, globalHeight),
                QuestionBoxLocation.MiddleCenter        => new(Core.Resolution.Bounds.Center.X - halfGlobalWidth, 
                                                             Core.Resolution.Bounds.Center.Y - halfGlobalHeight, 
                                                             globalWidth, globalHeight),
                QuestionBoxLocation.MiddleRight         => new(Core.Resolution.Bounds.Right - globalWidth,
                                                             Core.Resolution.Bounds.Center.Y - halfGlobalHeight,
                                                             globalWidth, globalHeight),
                QuestionBoxLocation.BottomLeft          => new(Core.Resolution.Bounds.Left,
                                                             Core.Resolution.Bounds.Bottom - globalHeight,
                                                             globalWidth, globalHeight),
                QuestionBoxLocation.BottomCenter        => new(Core.Resolution.Bounds.Center.X - halfGlobalWidth,
                                                             Core.Resolution.Bounds.Bottom - globalHeight,
                                                             globalWidth, globalHeight),
                QuestionBoxLocation.BottomRight         => new(Core.Resolution.Bounds.Right - globalWidth,
                                                             Core.Resolution.Bounds.Bottom - globalHeight,
                                                             globalWidth, globalHeight),

                QuestionBoxLocation.DialogTopLeft       => new(Core.Resolution.Bounds.Right - globalWidth - _globalPaddingForDialog.X,
                                                             Core.Resolution.Bounds.Top + 58 + _globalPaddingForDialog.Y,
                                                             globalWidth, globalHeight),
                QuestionBoxLocation.DialogTopRight      => new(Core.Resolution.Bounds.Left + _globalPaddingForDialog.X,
                                                             Core.Resolution.Bounds.Top + 58 + _globalPaddingForDialog.Y,
                                                             globalWidth, globalHeight),
                QuestionBoxLocation.DialogMiddleLeft    => new(Core.Resolution.Bounds.Right - globalWidth - _globalPaddingForDialog.X,
                                                             Core.Resolution.Bounds.Center.Y + 36 + _globalPaddingForDialog.Y,
                                                             globalWidth, globalHeight),
                QuestionBoxLocation.DialogMiddleRight   => new(Core.Resolution.Bounds.Left + _globalPaddingForDialog.X,
                                                             Core.Resolution.Bounds.Center.Y + 36 + _globalPaddingForDialog.Y,
                                                             globalWidth, globalHeight),
                QuestionBoxLocation.DialogBottomLeft    => new(Core.Resolution.Bounds.Right - globalWidth - _globalPaddingForDialog.X,
                                                             Core.Resolution.Bounds.Bottom - globalHeight - 58 + _globalPaddingForDialog.Y,
                                                             globalWidth, globalHeight),
                QuestionBoxLocation.DialogBottomRight   => new(Core.Resolution.Bounds.Left + _globalPaddingForDialog.X,
                                                             Core.Resolution.Bounds.Bottom - globalHeight - 58 + _globalPaddingForDialog.Y, 
                                                             globalWidth, globalHeight),
